...
export const _products = () =>
  Array.from({ length: 20 }, (_, index) => {
    ...
    return {
      ...
      sizes: ['6', '7', '8', '8.5', '9', '9.5', '10', '10.5', '11', '11.5', '12', '13'] as string[],
      subDescription:
        'Featuring the original ripple design inspired by Japanese bullet trains, the Nike Air Max 97 lets you push your style full-speed ahead.' as string,
    };
  });
